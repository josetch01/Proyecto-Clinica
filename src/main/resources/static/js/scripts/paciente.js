const url = "/sistemaginecofem/api/pacientes/";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(js, function (index, value) {
                t.row.add([value.id, value.nombre+" "+value.apellidos,value.nacimiento,value.documento,value.telefono,value.direccion+ " - "+value.ciudad,value.estado, botonera]);
            });
            t.draw(false);
        },
    }).fail(function () {
